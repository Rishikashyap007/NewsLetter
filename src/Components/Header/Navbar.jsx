...
function Navbar(){
    return(
        ...
        <div className="navbarclass">
            <div >
            <img src="https://substackcdn.com/image/fetch/w_88,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F048641cb-ee19-431b-80cc-e15ed631dd2f_256x256.png" className="navbar-img1"/>
            ...
            <div className="navbar-btnclass">
                <button className="navbarbtn btn1"><i class="fa-solid fa-magnifying-glass"></i></button>
                <button className="navbarbtn btn1"><i class="fa-solid fa-arrow-up-from-bracket"></i></button>
                <button className="navbarbtn btn2">+ subscribe</button>
                <button className="navbarbtn btn3">Sign in</button>
            </div>
        </div>
        ...
        <hr/>
         <div className="navbar_secondpart">
            <div >
              <img src="https://substackcdn.com/image/fetch/w_848,h_477,c_fill,f_webp,q_auto:good,fl_progressive:steep,g_center/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F897f83a1-fe39-4ff1-9266-286c6d6b7386_1989x1421.png" className="navbar_image"></img>
            </div>
